...
/* Math class: All the methods in the math class are static and 
we do NOT need an instance of the object to call the methods. */
...
public class ExampleThree {
    public static void main(String[] args) {
        ...
        /*
         * Formula for random numbers is (int) (Math.random() * numberOfOptions) + startingValue
         */
